...
public class MapGenerator : MonoBehaviour
{
    ...
    public void Generate()
    {
        ...
        Vector2Int cornerPos = new Vector2Int();

        if(generateOnZero)
        cornerPos = new Vector2Int(- chankCol.x * chankUnitSize.x / 2,
                                   - chankCol.y * chankUnitSize.y / 2);
        else
        cornerPos = new Vector2Int(_startMapPosition.x - chankCol.x * chankUnitSize.x / 2,
            ...
            if (trackingTarget.transform.position.y < botCentralChankPos - trasholdTileRedraw)
            {
                ...
                for (int i = 0; i < chankCol.y; i++)
                {
                    for (int j = 0; j < chankCol.x; j++)
                    {
                        ...
                        {
                            int internalIndex = chankSet[currentIndex].index;
    ...
    public Vector4 GetCentralBox()
    {
        return new Vector4(botCentralChankPos,
                           topCentralChankPos,
                           leftCentralChankPos,
                           rightCentralChankPos);
    }
    ...
    public bool IsCancelGenerate()
    {
        return mapIsGenerated;
    }
    public Vector2 GetBotLeftCorner()
    {
        return findCornerPos();
    }
    public Vector2Int GetChankUnitSize()
    {
        return chankUnitSize;
    }
    public Vector2Int GetChankCol()
    {
        return chankSize;
    }
    public Vector2Int GetMapSize()
    {
        return chankCol * chankUnitSize;
    }
    public Chank[] GetChankData()
    {
        return chankSet;
    }
    public class Chank
    {
        ...
        public float _rareRank { get; set; }
        ...
        public Vector2 GetUnitChankSize() { return new Vector2(_size.x * _tileSize.x, _size.y * _tileSize.y); }
